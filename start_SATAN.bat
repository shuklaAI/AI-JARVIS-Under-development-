...
title SATAN AI - Premium Launcher
cd /d "%~dp0"
...
echo.
echo ==============================================
echo      SATAN AI  ^| Premium Launcher
echo ==============================================
echo.
...
echo.
echo Launching SATAN AI...
if exist "%PYW%" (
  start "SATAN AI" /b "%PYW%" "%MAIN%" --startup
) else (
  start "SATAN AI" /b "%PYCMD%" "%MAIN%" --startup
)
