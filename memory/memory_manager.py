...
def should_extract_memory(user_text: str, SATAN_text: str, api_key: str = "") -> bool:
    try:
        from or_client import client

        combined = f"User: {user_text[:300]}\nSATAN AI: {SATAN_text[:1000]}"
...
def extract_memory(user_text: str, SATAN_text: str, api_key: str = "") -> dict:
    try:
        from or_client import client

        combined = f"User: {user_text[:600]}\nSATAN AI: {SATAN_text[:300]}"
        ...
        raw = client.chat(
            ...
            f"                  (e.g. mark_xxv: 'Building a SATAN AI - Lite assistant')\n"
            ...
            f"- Extract from BOTH user and SATAN AI turns.\n"
            ...
            f' "projects":{{"mark_xxv":{{"value":"SATAN AI - Lite assistant"}}}},\n'
