...
from actions import SATAN_connect as bc
...
class FakeService:
    ...
    def create_pairing_offer(self, *, device_name: str = "Unknown Device", platform: str = "unknown"):
        return {"service": "_SATAN._tcp.local.", "host": "192.168.1.20", "port": 8765, "pairing_token": "token", "pairing_code": "123456", "expires": 300}

    async def disconnect_device(self, target: str, *, reason: str = "Disconnected by SATAN"):
