...
from SATAN_connect.gateway.command_router import CommandRouter
from SATAN_connect.gateway.device_manager import DeviceManager
from SATAN_connect.gateway.capability_manager import CapabilityManager
from SATAN_connect.gateway.models import DeviceRecord
from SATAN_connect.gateway.pairing import PairingManager
from SATAN_connect.gateway.protocol import ProtocolTypes, build_message, validate_message
from SATAN_connect.gateway.websocket import ConnectionHub
...
def test_pairing_manager_returns_expiring_offer():
    ...
    assert offer.service == "_SATAN._tcp.local."
