...
PROJECTS_DIR     = Path.home() / "Desktop" / "SATANProjects"
MAX_FIX_ATTEMPTS = 5
...
def _resolve_workspace_directory(
    ...
    project_dir = PROJECTS_DIR / (project_name or "SATAN_project")
...
def _build_project(
    ...
    proj_name    = project_name or plan.get("project_name", "SATAN_project")
