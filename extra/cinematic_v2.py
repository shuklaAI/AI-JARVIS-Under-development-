...
new_setup_overlay = r'''class SetupOverlay(QWidget):
    ...
    def _build_stage3(self):
        ...
        hint = QLabel("<a href='https://aistudio.google.com/app/apikey' style='color: rgba(255,50,50,0.5); text-decoration: none; font-size: 10px;'>Get API Key →</a>")
        ...
        self._launch_btn = QPushButton("Launch SATAN Echo →")
