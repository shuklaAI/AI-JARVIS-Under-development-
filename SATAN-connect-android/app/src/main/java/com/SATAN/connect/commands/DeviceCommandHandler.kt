package com.SATAN.connect.commands
...
import com.SATAN.connect.core.SATANConnectCapabilities
import com.SATAN.connect.core.CommandResult
import com.SATAN.connect.device.AndroidDeviceInfoProvider
    ...
    private fun getDeviceInfo(): CommandResult {
        ...
        return CommandResult(
            ...
            data = mapOf(
                ...
                "capabilities" to SATANConnectCapabilities.INITIAL,
            ),
        )
    }
